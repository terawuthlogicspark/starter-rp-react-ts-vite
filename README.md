...
[![Open in StackBlitz](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/github.com/react-pdf-dev/starter-rp-react-ts-vite)
...
1. **Clone the Repository**: If you haven't already, clone the repository and navigate into the project directory.
   ...
   ```bash
   git clone https://github.com/react-pdf-dev/starter-rp-react-ts-vite.git
